      ...
      if (box_led.contain(t.x, t.y))          // LEDエフェクトタップボタンの追加
      {
        ...
        switch (currentEffectIndex) {
          ...
          case 4:
            ...
            effects02 = NeoPixelEffects(pb_leds, PULSE, 0, 59, 8, 0, CRGB::Magenta, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, PULSE, 0, 59, 8, 0, CRGB::Magenta, true, REVERSE);      // ※利用する場合はコメントアウトを外してください
            break;
          case 5:
            effects01 = NeoPixelEffects(internal_leds, STATIC, 0, 9, 3, 100, CRGB::Orange, true, FORWARD); // 同色がチラチラ点滅するキラキラ系エフェクト
            effects02 = NeoPixelEffects(pb_leds, STATIC, 0, 59, 3, 100, CRGB::Orange, true, FORWARD);     // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, STATIC, 0, 59, 3, 100, CRGB::Orange, true, FORWARD);     // ※利用する場合はコメントアウトを外してください
            break;
          case 6:
          ...
          case 8:
            ...
            effects02 = NeoPixelEffects(pb_leds, STROBE, 0, 59, 3, 100, CRGB::Orange, true, FORWARD);     // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, STROBE, 0, 59, 3, 100, CRGB::Orange, true, FORWARD);     // ※利用する場合はコメントアウトを外してください
            break;
          case 9:
            effects01 = NeoPixelEffects(internal_leds, SINEWAVE, 0, 9, 3, 20, CRGB::Green, true, FORWARD); // 指定したLED弾数だけ消灯しながら流れるエフェクト (COMETの逆イメージ)
            effects02 = NeoPixelEffects(pb_leds, SINEWAVE, 0, 59, 10, 20, CRGB::Green, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, SINEWAVE, 0, 59, 10, 20, CRGB::Green, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            break;
          case 10:
            effects01 = NeoPixelEffects(internal_leds, RANDOM, 0, 9, 3, 70, CRGB::LightGoldenrodYellow, true, FORWARD); // LED全弾がランダムに全色点灯 (パリピエフェクト)
            effects02 = NeoPixelEffects(pb_leds, RANDOM, 0, 59, 3, 70, CRGB::Yellow, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, RANDOM, 0, 59, 3, 70, CRGB::YellowGreen, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            break;
          case 11:
            ...
            effects02 = NeoPixelEffects(pb_leds, TRIWAVE, 0, 59, 8, 20, CRGB::Yellow, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, TRIWAVE, 0, 59, 8, 20, CRGB::YellowGreen, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            break;
          case 12:
            ...
            break;
          case 13:
            effects01 = NeoPixelEffects(internal_leds, FADEINOUT, 0, 9, 3, 0, CRGB::LightGoldenrodYellow, true, FORWARD); // PULSEと同一エフェクト (4秒)
            effects02 = NeoPixelEffects(pb_leds, FADEINOUT, 0, 59, 3, 0, CRGB::Yellow, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, FADEINOUT, 0, 59, 3, 0, CRGB::YellowGreen, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            break;
          case 14:
            effects01 = NeoPixelEffects(internal_leds, NANAIRO, 0, 9, 3, 0, CRGB::LightGoldenrodYellow, true, FORWARD); // PULSEと同一エフェクト (4秒:七色に順番点灯)
            effects02 = NeoPixelEffects(pb_leds, NANAIRO, 0, 59, 3, 0, CRGB::Yellow, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, NANAIRO, 0, 59, 3, 0, CRGB::YellowGreen, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            break;
          case 15:
            effects01 = NeoPixelEffects(internal_leds, MERAMERA, 0, 9, 3, 70, CRGB::LightGoldenrodYellow, true, FORWARD); // LED全弾が暖色でメラメラと変化するエフェクト
            effects02 = NeoPixelEffects(pb_leds, MERAMERA, 0, 59, 3, 70, CRGB::Yellow, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            effects03 = NeoPixelEffects(pc_leds, MERAMERA, 0, 59, 3, 70, CRGB::YellowGreen, true, FORWARD);      // ※利用する場合はコメントアウトを外してください
            break;
          case 16:
