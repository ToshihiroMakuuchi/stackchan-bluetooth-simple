...
void Avatar::draw() {
  ...
  DrawContext *ctx = new DrawContext(this->expression, this->breath,
                                     ...
                                     this->rotation, this->scale, this->offsetX, this->offsetY, this->colorDepth, this->speechFont);
  face->draw(ctx);
  delete ctx;
}
...
void Avatar::setOffset(int offsetX, int offsetY) { this->offsetX = offsetX; this->offsetY = offsetY; }
